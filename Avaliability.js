...
const available = filterProducts(products, item => item.inStock);
...
*/
const mapped = products.map(products => products.name.toUpperCase())
  console.log(mapped);
...
const discountedPrice = products.map(applyDiscount(20));
console.log("Discounted Prices included with discounted:", discountedPrice);
